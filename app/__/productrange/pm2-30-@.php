...
<?php include '_/xui/std/page-01/header-v.php' ?> 
        ...
        <div class="sub_container policy_container">
    		<div class="container mini_container">
            					<p>- Sub-base for roads&nbsp;</p>				                
                     <div class="row">
				                  	<div class="col-md-4 col-sm-4 col-xs-6">
                    	<a class="box_con" href="<?=o()->site_url?>/productrange/view/pm2-30/">
                        	<img src="<?=o()->asset_url?>/stylecrete_images/stylecrete15203956161.jpg" class="img-responsive"/>
                            <h5>PM2-30</h5>
                        </a>
                    </div>                     
                </div>       
