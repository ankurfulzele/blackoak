  ...
  <?php include '_/xui/std/page-01/header-v.php' ?>
        ...
        <div class="sub_container policy_container">
    		<div class="container mini_container">
                    	...
                    	<a class="box_con" href="<?=o()->site_url?>/productrange/view/10-7-mm-concrete/">
                        	<img src="<?=o()->asset_url?>/stylecrete_images/stylecrete1733807094.jpg" class="img-responsive"/>
