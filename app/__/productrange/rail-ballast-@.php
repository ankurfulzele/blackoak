      ...
      <div class="sub_heading">
        ...
        <div class="sub_container policy_container">
    		<div class="container mini_container">
            					<p>- Single sized aggregate.<br /> - Generally used for train tracks</p>				                
                <div class="row">
				                  	<div class="col-md-4 col-sm-4 col-xs-6">
                    	<a class="box_con" href="<?=o()->site_url?>/productrange/view/rail-ballast/">
                        	<img src="<?=o()->asset_url?>/stylecrete_images/stylecrete15203958671.jpg" class="img-responsive"/>
                            <h5>Rail Ballast</h5>
                        </a>
                    </div>                     
                </div>        
