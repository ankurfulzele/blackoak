...
<div class="sub_heading">
        ...
        <div class="sub_container policy_container">
    		<div class="container mini_container">
            					<p>- Road base material.<br /> - Roads, pads, carparks</p>				                
             <div class="row">
				                  	<div class="col-md-4 col-sm-4 col-xs-6">
                    	<a class="box_con" href="<?=o()->site_url?>/productrange/view/pm2-20/">
                        	<img src="<?=o()->asset_url?>/stylecrete_images/stylecrete1733807026.jpg" class="img-responsive"/>
                            <h5>PM2-20</h5>
                        </a>
                    </div>                     
                </div>        
