        ...
        <div class="sub_container policy_container">
    		<div class="container">            	
                <ol class="breadcrumb">				
                  ...
                  <li><a href="<?=o()->site_url?>/productrange/rail-ballast">Rail Ballast</a></li>				   
                  <li class="active">Rail Ballast </li>
              ...
              <div class="row">
               <div class="col-md-5">
               		<ul class="gallery clearfix">
					                        <li><a href="<?=o()->asset_url?>/stylecrete_images/Rail_Ballast15203958670.jpg" rel="prettyPhoto[gallery1]"><img src="<?=o()->asset_url?>/stylecrete_images/Rail_Ballast15203958670.jpg"/><span class="over"></span></a></li>
					                    </ul>
               </div>
                     ...
                     <ul class="nav nav-tabs" role="tablist">
                      ...
                      <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="product_highlights">
							<p><ul> <li>Single sized aggregate.</li> <li>Generally used for train tracks</li> </ul> </p>
                        </div>
