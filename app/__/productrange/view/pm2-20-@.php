        ...
        <div class="sub_container policy_container">
    		<div class="container">            	
                <ol class="breadcrumb">				
                  ...
                  <li><a href="<?=o()->site_url?>/productrange/pm2-20">PM2-20</a></li>				   
                  <li class="active">PM2-20 </li>				   
                </ol>                
              <div class="row">
               <div class="col-md-5">
               		<ul class="gallery clearfix">
					                        <li><a href="<?=o()->asset_url?>/stylecrete_images/PM2-201733807026153.jpg" rel="prettyPhoto[gallery1]"><img src="<?=o()->asset_url?>/stylecrete_images/PM2-201733807026153.jpg"/><span class="over"></span></a></li>
					                    </ul>
               </div>            
