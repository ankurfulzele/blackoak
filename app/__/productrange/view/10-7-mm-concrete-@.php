  ...
  <body>
    <?php include '_/xui/std/page-01/header-v.php' ?>
        <div class="sub_heading">
        	<h4><span>10-7 MM concrete</span></h4>
        </div><!-- sub_heading -->
        <div class="sub_container policy_container">
    		<div class="container">            	
                <ol class="breadcrumb">				
                  ...
                  <li><a href="<?=o()->site_url?>/productrange/10-7-mm-concrete">10-7 MM concrete</a></li>				   
                  <li class="active">10-7 MM concrete </li>				   
                </ol>                
              <div class="row">
               <div class="col-md-5">
               		<ul class="gallery clearfix">
					                        <li><a href="<?=o()->asset_url?>/stylecrete_images/10-7_MM_concrete1733807094152.jpg" rel="prettyPhoto[gallery1]"><img src="<?=o()->asset_url?>/stylecrete_images/10-7_MM_concrete1733807094152.jpg"/><span class="over"></span></a></li>
					                    </ul>
               </div>
            
               <div class="col-md-7 view_text">
               		<h5>10-7 MM concrete</h5>
                     ...
                     <ul class="nav nav-tabs" role="tablist">
                      ...
                      <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="product_highlights">
							...
							<p><ul>
	<li>Used for concrete products&nbsp;&nbsp;</li>
</ul>
 </p>
                        </div>
