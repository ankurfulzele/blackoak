        ...
        <div class="sub_container policy_container">
    		<div class="container">
                <ol class="breadcrumb">				
                  ...
                  <li><a href="<?=o()->site_url?>/productrange/rock-armour">Rock Armour</a></li>				   
                  <li class="active">Rock Armour </li>				   
                </ol>
                
              <div class="row">
               <div class="col-md-5">
               		<ul class="gallery clearfix">
					                        <li><a href="<?=o()->asset_url?>/stylecrete_images/Rock_Armour1733806918155.jpg" rel="prettyPhoto[gallery1]"><img src="<?=o()->asset_url?>/stylecrete_images/Rock_Armour1733806918155.jpg"/><span class="over"></span></a></li>
					                    </ul>
               </div>
                     ...
                     <ul class="nav nav-tabs" role="tablist">
                      ...
                      <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="product_highlights">
							...
							<p><ul>
	<li>Size varies between 300mm &ndash; 60mm &ndash; 900mm.</li>
	<li>Generally used for sea walls, slope stability and bridge abutments.</li>
</ul>
 </p>
                        </div>
