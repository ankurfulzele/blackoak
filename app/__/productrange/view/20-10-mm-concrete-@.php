        ...
        <div class="sub_container policy_container">
    		<div class="container">            	
                <ol class="breadcrumb">				
				  ...
				  <li><a href="<?=o()->site_url?>/productrange/20-10-mm-concrete">20-10 MM concrete</a></li>				   
                  <li class="active">20-10 MM concrete </li>				   
                </ol>                
              <div class="row">
               <div class="col-md-5">
               		<ul class="gallery clearfix">
					                        <li><a href="<?=o()->asset_url?>/stylecrete_images/20-10_MM_concrete1733806610156.jpg" rel="prettyPhoto[gallery1]"><img src="<?=o()->asset_url?>/stylecrete_images/20-10_MM_concrete1733806610156.jpg"/><span class="over"></span></a></li>
					                    </ul>
               </div>            
