        ...
        <div class="sub_container policy_container">
    		<div class="container">            	
                <ol class="breadcrumb">				
                  ...
                  <li><a href="<?=o()->site_url?>/productrange/pm2-30">PM2-30</a></li>
				   
                  <li class="active">PM2-30 </li>
              ...
              <div class="row">
               <div class="col-md-5">
               		<ul class="gallery clearfix">
					                        <li><a href="<?=o()->asset_url?>/stylecrete_images/PM2-3015203956160.jpg" rel="prettyPhoto[gallery1]"><img src="<?=o()->asset_url?>/stylecrete_images/PM2-3015203956160.jpg"/><span class="over"></span></a></li>
					                    </ul>
               </div>
                     ...
                     <ul class="nav nav-tabs" role="tablist">
                      ...
                      <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="product_highlights">
							...
							<p><ul> <li>Sub-base for roads&nbsp;</li> </ul> </p>
                        </div>
